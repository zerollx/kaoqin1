    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'util'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'name', title: '打卡人', width: 150, sort: true, totalRow: true}
                , {field: 'morning', title: '打卡日期', width: 200, sort: true}
                , {
                    field: 'situation', title: '备注', width: 200, sort: true, templet: function (d) {
                        if (d.situation == 1) {
                            return '上班正常'
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                case 'add':
                    layer.msg('添加');
                    xadmin.open("添加页面", "RepairCard_Add.jsp", 1000, 650);
                    break;
                case 'update':
                    if (data.length === 0) {
                        layer.msg('请选择一行');
