    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'util'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'ccode', title: '班次编码', width: 160, sort: true, totalRow: true}
                , {field: 'cname', title: '班次名称', width:160, sort: true}
                , {field: 'cmorning', title: '早上上班时间', width:220, sort: true}
                , {field: 'cafternoon', title: '下午下班时间', width: 220, sort: true}
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                case 'add':
                    layer.msg('添加');
                    xadmin.open("添加页面", "Classes_Add.jsp", 1000, 650);
                    break;
                case 'update':
                    if (data.length === 0) {
                        layer.msg('请选择一行');
