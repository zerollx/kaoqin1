...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="punchPeople" autocomplete="off" class="layui-input" lay-verify="required"
                   value="${username}">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="punchDate" autocomplete="off" class="layui-input" lay-verify="required"
    ...
    <%--<div class="layui-input-inline">--%>
    <%--<input style="height: 80px;width: 400px" type="text" name="punchRemarks" autocomplete="off" class="layui-input" lay-verify="required">--%>
    <%--</div>--%>
    <%--</div>--%>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="punchRemarks" id="punchRemarks">
                <option value=" "></option>
...
<script>
    ...
    layui.use('form', function () {
        ...
        form.on('submit(formDemo)', function (data) {
            ...
            // var val1 = $("#sPart").val();
            var val = $("#punchRemarks").val();
            // var val2 = $("#sSuper").val();
            $.ajax({
                type: "post",
                url: "/PunchAdd",
                data: {
                    "punchPeople": data.field.punchPeople,
