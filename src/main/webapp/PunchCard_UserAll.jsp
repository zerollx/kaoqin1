    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'util'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'punchPeople', title: '打卡人', width: 160, sort: true, totalRow: true}
                , {field: 'punchDate', title: '打卡日期', width: 220, sort: true}
                , {
                    field: 'punchRemarks', title: '备注', width: 250, sort: true, templet: function (d) {
                        if (d.punchRemarks == 1) {
                            return '上班打卡'
                        } else if(d.punchRemarks == 2){
                            return '下班打卡'
                        }
                    }
                }
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                case 'add':
                    layer.msg('添加');
                    xadmin.open("添加页面", "PunchCard_Add.jsp", 1000, 650);
                    break;
                case 'update':
                    if (data.length === 0) {
                        layer.msg('请选择一行');
