    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'util'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'repairPeople', title: '打卡人', width: 160, sort: true, totalRow: true}
                , {field: 'repairDate', title: '打卡日期', width:220, sort: true}
                , {field: 'repairReason', title: '备注', width:250, sort: true}
