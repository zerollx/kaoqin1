    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'util'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'scode', title: '岗位编号', width: 120, sort: true, totalRow: true}
                , {field: 'sname', title: '岗位名称', width: 120, sort: true}
                , {field: 'spart', title: '所在部门', width: 150, sort: true}
                , {field: 'ssuper', title: '直接上级', width: 130, sort: true}
                , {field: 'stype', title: '岗位类别', width: 130, sort: true}
                , {field: 'sdescribe', title: '岗位职责描述', width: 170, sort: true}
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                case 'add':
                    layer.msg('添加');
                    xadmin.open("添加页面", "/DepartmentFindAll", 1000, 650);
                    break;
                case 'update':
                    if (data.length === 0) {
                        layer.msg('请选择一行');
        ...
        table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') {
                ...
                xadmin.open('修改界面', 'findById2?id='+ obj.data.id, 1200, 660)
            }
        });
