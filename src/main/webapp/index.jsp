...
<link rel="stylesheet" href="./css/theme1525.min.css">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                <!-- 二级菜单 -->
                <dd>
                    <a onclick="xadmin.open('个人信息','personInfo.jsp')">个人信息</a></dd>
                <dd>
    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <%--<li>--%>
                        <%--<a onclick="xadmin.add_tab('查看个人信息','personInfo.jsp')">--%>
                            <%--<i class="iconfont">&#xe6a7;</i>--%>
                            <%--<cite>查看个人信息</cite></a>--%>
                    <%--</li>--%>
                    <li>
                        <a onclick="xadmin.add_tab('员工','Employee_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>员工</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('部门','Department_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>部门</cite></a>
                    </li>
                        <li>
                            <a onclick="xadmin.add_tab('岗位','Station_UserAll.jsp')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>岗位</cite></a>
                        </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="考勤架构">&#xe723;</i>
                    <cite>考勤架构</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('班次','Classes_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>班次</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('打卡单','PunchCard_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>打卡单</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('补卡单','RepairCard_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>补卡单</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('考勤表','CheckReport_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>考勤表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('派薪表','Salary_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>派薪表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('请假表','Leave_UserAll.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>请假表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('查看库存列表','inventory.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>查看库存列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="出入库管理">&#xe726;</i>
                    <cite>出入库管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('出入库记录表','opertreetable.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>出入库记录表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('出入库历史记录','Recorduserall.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>出入库历史记录</cite></a>
                    </li>
                    <%--<li>--%>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('商品管理表','Productuserall.jsp')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>商品管理表(一对一表)</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('订单表','/po')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>订单表(一对多表)</cite></a>
                    </li>
                </ul>
            </li>
            <li>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='success.jsp' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
